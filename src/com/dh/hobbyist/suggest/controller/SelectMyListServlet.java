...
/**
 * Servlet implementation class SelectMyListServlet
 */
@WebServlet("/selectMyList.sg")
public class SelectMyListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ss.getMyListCount(memberCode);
		...
		ArrayList<Petition> list = ss.selectMyList(memberCode, pi);
		
		String page = "";
		if(list != null) {
			page = "views/member/myPage/myLesson/registeredSuggestion.jsp";
			request.setAttribute("suggestList", list);
			request.setAttribute("pi", pi);
		} else {
			page = "views/common/errorPage.jsp";
			request.setAttribute("msg", "마이페이지 등록한 건의 조회 실패");
		}
