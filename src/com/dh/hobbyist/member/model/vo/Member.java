...
public class Member implements java.io.Serializable{
	...
	public Member(int memberCode, String memberId, String memberPwd, String memberName, String phone, String email,
			String bankName, String bankNum, int del, int points, Date regDate, int firstLogin, int warnings,
			int isArtist, Date artistAccepted) {
		super();
	...
	public String toString() {
		return "Member [memberCode=" + memberCode + ", memberId=" + memberId + ", memberPwd=" + memberPwd
				...
				+ ", bankNum=" + bankNum + ", del=" + del + ", points=" + points + ", regDate=" + regDate
				+ ", firstLogin=" + firstLogin + ", warnings=" + warnings + ", isArtist=" + isArtist
				+ ", artistAccepted=" + artistAccepted + "]";
	}
