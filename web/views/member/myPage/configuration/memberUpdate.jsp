		...
		<form>
			<table align="border" class="tablecenter4">
				<tr>
					...
					<td colspan="5" class="id" style="text-align:left;"><input style="width:260px;" type="text" name="text" max-length=15 autofocus placeholder="아이디를 입력하세요."></td>
					<td></td>
				</tr>
				
				<tr>
					<td colspan="1" style="width:70px; text-align:left;"><label id="labelName">이름</label></td>
					<td colspan="5" class="nm"  style="text-align:left;"><input style="width:260px;" type="name" name="name" max-length=5 placeholder="이름을 입력하세요."></td>
					<td></td>
				</tr>
				
				<tr>
					<td colspan="1" style="width:70px; text-align:left;"><label id="LabelEmail">이메일</label></td>
					<td colspan="5" class="em" style="text-align:left; ">
					<input  style="width:260px;" type="email" name="email" placeholder="이메일을 입력하세요."></td>
					<td></td>				
				</tr>
			
				<tr>
					<td colspan="1" style="width:70px; text-align:left;"><label id="labelTell">전화번호</label></td>
					<td colspan="1"><input type="tel" name="tel1" style="text-align:left; width:70px;"></td>
					<td colspan="1" style="width:3px;"><lable id="labelHyphen1">-</lable></td>
					<td colspan="1"><input type="tel" name="tel2" style="text-align:left; width:70px;"></td>
					<td colspan="1" style="width:3px;"><lable id="labelHyphen2">-</lable></td>
					<td colspan="1"><input type="tel" name="tel3" style="text-align:left; width:70px;"></td>
				...
				<tr>
					...
					<select  name="bank" style="width:70px;" >
