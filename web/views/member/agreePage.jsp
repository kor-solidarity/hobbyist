...
다. 기존 회원들은 당사가 변경된 약관의 수정사항을 홈페이지 또는 이메일 등의 방법을 통해 공지한 경우, 웹사이트 또는 서비스를 지속적으로 이용할 경우에 변경 사항에 대해 동의 한 것으로 간주합니다. 만일 수정 약관에 대해 동의하지 않는 경우에는 사이트와 서비스 이용을 즉시 중단 하거나 탈퇴함으로써 약관의 내용을 거부할 수 있습니다.<br>


제3조 (약관 외 사항의 처리)<br>

본 약관과 개인정보취급방침에 명시되지 않은 사항에 대해서는 관련 법령 및 회사가 정한 서비스 이용 안내에 따릅니다.<br>
...
가. 학생 : 아티스트를 구하기 위해 당사의 약관에 동의하고 일반 회원 양식에 따라 등록한 자.

나. 아티스트 : 학생을 구하기 위해 당사의 약관에 동의하고 일반 회원에서 추가로 아티스트 양식에 따라 등록한 자.

다. 학생과 아티스트가 처음 진행하는 1시간 수업에서 최소 20분간의 OT를 필수로 진행하여야 합니다. 1회 수업은 1시간만 포함하며 이후 진행된 시간은 추가 수업으로 간주됩니다.
...
회사는 이용자에게 본인확인, 결제 서비스, 다양하고 편리한 인터넷 서비스를 제공하기 위하여 아래의 방법을 통해 개인정보를 수집하고 있습니다.</p><br>


가. 개인정보 수집항목<br>

- 성명, 관심재능, 비밀번호, 휴대전화번호, E-Mail, 계좌번호 등<br>

나. 서비스 이용과정 및 사업 처리과정에서 수집될 수 있는 개인정보의 범위<br>

- 서비스 이용기록, 접속 로그, 쿠키, 접속IP정보, 결제기록, 이용정지 기록<br>

다. 개인정보의 수집방법<br>

- 회사는 이용자가 사이트 가입시 개인정보 보호정책과 이용약관의 각각의 내용에대해 회원가입시 각각의 내용에 대해 동의를 할 수 있는 절차를 고지하여, 회원가입이 진행된 경우 개인정보 수집에 대해 동의한 것으로 봅니다.<br>

라. 허위 정보 입력 시 회사의 조치<br>
