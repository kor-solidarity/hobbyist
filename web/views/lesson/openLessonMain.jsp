...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fa120e8648138856b30621abf3ebb591&libraries=services,clusterer, drawing"></script>
	...
	<script>
		...
		function displayPlaces(places) {
			...
			for(var i = 0; i < places.length; i++) {
				...
				//마커와 검색결과 항목에 mouseover 했을 때 해당장소의 인포윈도우에 장소명 표시
				//mouseout 시 윈포윈도우 닫음
		...
		function addMarker(position, idx, title) {
			var imageSrc = 'http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png', //마커 이미지 url, 스프라이트 이미지 사용함
				imageSize = new kakao.maps.Size(36, 37),
				imgOptions = {
					spriteSize : new kakao.maps.Size(36, 691), 	// 스프라이트 이미지의 크기	
					spriteOrigin : new kakao.maps.Point(0, (idx * 46) + 10),	//스프라이트 이미지 중 사용할 영역의 최상단 좌표
